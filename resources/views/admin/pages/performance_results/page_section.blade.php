...
@section('content')
    <div class="page-header mb-2">
        ...
        <ul class="breadcrumbs mb-1 ps-0 ms-0 text-start">
            ...
            <li class="nav-item">
                <a href="#">{{ $PerfResultsType->type_name }}</a>
            </li>
        </ul>
    </div>
                    ...
                    @foreach ($PerfResultsSection as $index => $details)
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <form action="{{ route('PerformanceResultsSectionDelete', $details->id) }}" method="POST"
                            ...
                            <form action="{{ route('PerformanceResultsSectionUpdate', $details->id) }}" method="POST">
                                ...
                                <div class="modal-body">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="section_name-{{ $details->id }}"
                                            name="section_name" value="{{ $details->section_name }}">
                                    </div>
                                    <div class="mb-3">
                                        <label for="date" class="form-label">วันที่</label>
                                        <input type="date" class="form-control" id="date" name="date"
