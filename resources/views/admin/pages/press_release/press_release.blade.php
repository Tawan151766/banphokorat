...
@section('content')
    <div class="page-header mb-2">
        <h4 class="fw-bold mb-2 me-3">จัดการข่าวประชาสัมพันธ์</h4>
                            ...
                            <div class="modal-body">
                                <div class="mb-3">
                                    <input type="hidden" name="post_type_id"
                                        value="{{ $postTypes->firstWhere('type_name', 'ข่าวประชาสัมพันธ์')->id }}">
                                ...
                                <div>
                                    ...
                                    <small class="text-muted">ขนาดไฟล์ต้องไม่เกิน 50MB และรองรับเฉพาะไฟล์ .mp4, .avi, .mov,
                                        .wmv</small>
                                </div>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="d-flex justify-content-center align-items-center">
                                    <div class="mb-1 me-1">
                                        <a href="{{ route('PressReleaseUpdatePage', $postDetail->id) }}"
                                    ...
                                    <div class="mb-1 me-1">
                                        <form action="{{ route('PressReleaseDelete', $postDetail->id) }}" method="POST"
                                            style="display:inline;">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn btn-danger btn-sm"
                                                onclick="return confirm('ยืนยันการลบใช่หรือไม่?')"><i
