...
<div class="page-header mb-2">
        ...
        <ul class="breadcrumbs mb-1 ps-0 ms-0 text-start">
            ...
            <li class="nav-item">
                <a href="#">{{ $LawsRegsSection->section_name }}</a>
            </li>
        </ul>
    </div>
            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" style="margin-top: 5%;">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('LawsAndRegulationsDetailCreate', $LawsRegsSection->id) }}" method="POST"
                    ...
                    @foreach ($LawsRegsFiles as $index => $details)
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <form action="{{ route('LawsAndRegulationsDetailDelete', $details->id) }}" method="POST"
